...
Nếu cần lưu trữ dữ liệu, hãy dùng volume. [[./Volume là cách để đồng bộ dữ liệu giữa máy chủ và máy ảo|Volume là cách để đồng bộ dữ liệu giữa máy chủ và máy ảo]]
