...
![[../assets/attachments/Phân loại câu nhập bằng tiếng Việt tự nhiên.png|Phân loại câu nhập bằng tiếng Việt tự nhiên.png]]
# Tính năng
## Phân loại thông tin
...
- [[./Mô hình xử lý dữ liệu|Mô hình xử lý dữ liệu]]
- Discord thảo luận